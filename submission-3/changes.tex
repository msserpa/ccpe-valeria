...
\begin{answer}
For this task we separated the CG-NPB discussion into a dedicated section (Section \ms{conferir}5.1 of the revised manuscript) where we deepened the analysis of the CG-NPB application, with a better description of its communication pattern and its DRAM accesses, to shed light on the prefetcher's performance on GC-NPB.
